          ...
          Container(
            ...
            child: DataTable(
                ...
                rows: widget.bookingData.map((entry) {
                  ...
                  String? dropdownValue = (widget.employeeData.indexWhere(
                                  (element) =>
                                      element.data()["id"].toString() ==
                                      entry.employee.toString()) ==
                              -1 ||
                          entry.employee.toString() == "null")
                      ? null
                      : widget.employeeData
                  ...
                  return DataRow(cells: [
                    ...
                    DataCell(SizedBox(
                        ...
                        child: (service.length == 1)
                            ? Text(
                                widget.washData.elementAt(
                                        widget.washData.indexWhere((element) => element.data()['id'] == service[0].trim()))[
                                    "name"],
                                style: GoogleFonts.inter(
