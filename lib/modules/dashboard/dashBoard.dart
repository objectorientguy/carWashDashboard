                  ...
                  onPressed: () async {
                    ...
                    if (selectedDate != null && selectedDate != _selectedDate) {
                      ...
                      context.read<DashboardBloc>().add(GetBookings(
                          id: "${selectedDate.year.toString().padLeft(4,
                              '0')}-${selectedDate.month.toString().padLeft(2,
                              '0')}-${selectedDate.day.toString().padLeft(2,
                              '0')}"));
                    }
                  },
              ...
              if (state is AddEmployeeLoaded) {
                context.read<DashboardBloc>().add(GetBookings(
                    id: (_selectedDate != null)
                        ? "${_selectedDate!.year.toString().padLeft(
                        4, '0')}-${_selectedDate!.month.toString().padLeft(
                        2, '0')}-${_selectedDate!.day.toString().padLeft(
                        2, '0')}"
                        : ""));
              }
